#' @title List Bgee releases available to use wiht BgeeDB package
#'
...
.getRelease <- function(){
  ...
  if (!file.exists("release.tsv")){
    stop("ERROR: File describing releases could not be downlaoded from FTP.")
  }
