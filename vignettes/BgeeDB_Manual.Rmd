...
It is possible to download data by combining available filters : 
...
Since version 2.13.2 (Bioconductor 3.11) BgeeDB store downloaded expression data in a local RSQLite database.
...
It is possible to remove .rds files generated in previous versions of BgeeDB and not used anymore with the
function. Thefunction below delete all .rds files for the selected species and for all datatype.
