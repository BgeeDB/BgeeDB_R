...
cell_data_bgee_gallus_gallus <- getCellRawData(bgee, experimentId = "ERP132576")
```

The result of the ```getCellRawData()``` depends on the package used to load the data. With \"zellkonverter\" it is an object of the class SingleCellExperiment. With \"anndata\" it is an object of the class AnnData. The expression levels are displayed as raw UMI counts.
