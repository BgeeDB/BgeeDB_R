...
test_that("Creating the topAnat object is working", {
  ...
  resFis <- runTest(myTopAnatObject, algorithm = 'classic', statistic = 'fisher')
  tableOver <- makeTable(myTopAnatData, myTopAnatObject, resFis, 1)

  expect_that( tableOver, is_a("data.frame") )
